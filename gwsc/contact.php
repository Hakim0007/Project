    ...
    <div class="contact-form-section">
        ...
        <div class="contact-form-wrap">
            <div class="contact-form-content">
                <form action="contact.php" method="POST" class="elements">
                    <div class="contact-form-input">
                        ...
                        <?php } else { ?>
                            <p class="login-to-contact" onclick="alert('Please Login to contact!')">Send</p>
                        <?php } ?>
                        <input type="reset" value="Cancel" title="Reset the input" />
                    </div>
                    <a href="privacypolicy.html" target="_blank" title="Privacy Policy">Our Privacy Policy</a>
                </form>
                <?php
                include "connection/configuration.php";
                ...
                if (isset($_POST['send'])) {
                    ...
                    $msg = $_POST['message'];
                    $date = date("Y:m:d:h:i");
                    $sql1 = "INSERT INTO contactus(name,email,message,datetime) values('{$fname}','{$email}','{$msg}','{$date}')";
        ...
        <div class="footer">
            <div class="footer-wrap">
                <div class="you-are-here">
                    ...
                    <a class="here" href="contact.php" title="Contact">CONTACT</a>|

...
<body>
    ...
    $sql = "SELECT * from sites where availability LIKE '%{$search_term}%' OR pitch_type LIKE '%{$search_term}%'";
    $result = mysqli_query($con, $sql) or die("Query failed");
    ?>
    <div class="gallery-section">
        <div class="gallery-section-header">
            <h1>Search results of "<?php echo $search_term; ?>" are:</h1>
            ...
            <div class="gallery-images">
                ...
                ?>
                        <div class="gallery">
                            ...
                            <h4 class="pitch-type"><?php echo $row['pitch_type']; ?></h4>
